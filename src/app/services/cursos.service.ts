...
export class CursosService {
  ...
  MisCursos = [
    ...
    { id: 9, categoria: 'Portugués', curso: 'Portugués de Negocios para Hispanos', sitio: 'https://go.hotmart.com/O98743990R', imagen: 'assets/images/CursoPortugues.png', estrellas: 'assets/images/4Estrellas.png' },
