...
import { DataPortug1Service } from 'src/app/services/data-portug1.service';
import { IntercambioDatosService } from 'src/app/services/intercambio-datos.service';
import { SharedModule } from 'src/app/Shared/shared.module';

@Component({
  selector: 'app-type1-por',
  standalone: true,
   imports: [CommonModule, ShufflePipe2, MatCardModule, ReactiveFormsModule, SharedModule],
  templateUrl: './type1-por.component.html',
  styleUrl: './type1-por.component.scss'
})
export class Type1PorComponent implements OnInit {
    ...
    private dataLevel1Service = inject(DataPortug1Service);
